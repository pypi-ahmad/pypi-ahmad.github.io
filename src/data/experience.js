      ...
      experiences: [
        {
          ...
          descriptions: [
            ...
            "Built a multi-agent document fraud detection engine using LangGraph and GPT-4o Vision that combines file-integrity checks, visual forensics, metadata analysis, semantic validation, and cross-document duplicate detection to produce deterministic 0-100 risk scoring with Accept/Review/Reject outcomes.",
            "Developed an agentic kickback and referral fraud detection platform for healthcare claims using LangGraph orchestration, NetworkX loop and hub-and-spoke analytics, and human-in-the-loop approval gates to generate evidence-backed provider network investigations.",
            "Implemented an out-of-network claims intelligence dashboard with Streamlit, Plotly, Pandas, and OpenAI-assisted analysis to detect CMS-benchmark price gouging, specialty-level outliers, hidden add-on billing, and appeals/complaint concentration patterns for payer investigation workflows.",
