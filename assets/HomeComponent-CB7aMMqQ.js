...
`;function D({theme:e}){return(0,x.jsxs)(C,{id:`selected-work`,"aria-labelledby":`selected-work-title`,children:[(0,x.jsx)(w,{id:`selected-work-title`,theme:e,...t(),children:`Personal projects & experiments`}),(0,x.jsx)(T,{children:f.map((e,t)=>(0,x.jsx)(b,{repo:e,caseStudy:!0,revealIndex:t},e.id))}),(0,x.jsx)(E,{className:`motion-action`,theme:e,to:`/projects`,children:`View projects`})]})}var O=p(m(),1),k=h.section`
  width: min(var(--container-max-width), calc(100% - (var(--page-gutter) * 2)));
  margin: 0 auto;
  padding-block-start: var(--section-spacing);
`,A=h(s.div)`
